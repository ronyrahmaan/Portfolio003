  ...
  return (
    <div className="relative h-screen overflow-hidden" style={{willChange: 'auto'}}>
      ...
      <div className="container mx-auto flex h-full max-w-4xl flex-col">
            ...
            {isEmptyState ? (
              ...
              loadingSubmit && (
                <motion.div
                  key="loading"
                  {...MOTION_CONFIG}
                  className="px-3 pt-3 min-h-[80px] flex items-center"
                >
        ...
        {/* Fixed Bottom Bar */}
        <div className="sticky bottom-0 bg-white px-2 pt-2 md:px-0 md:pb-3">
        ...
        <a
          ...
          className="fixed right-3 bottom-0 z-10 mb-3 hidden cursor-pointer items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs hover:underline md:block"
        >
          @ronstagrram
        </a>
      </div>
