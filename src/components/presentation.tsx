      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:items-start">
        ...
        <div className="flex flex-col space-y-4 md:order-2">
          ...
          <motion.p
            ...
            className="text-foreground mt-4 leading-relaxed whitespace-pre-line"
          >
            {profile.description}
          </motion.p>
        ...
        {/* Image section - positioned to fill bottom space */}
        <div className="relative mx-auto aspect-square w-full max-w-sm md:order-1 md:self-end">
