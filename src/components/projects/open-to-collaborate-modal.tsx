  ...
  return (
    <>
      <motion.button
        ...
        className="group relative flex items-center gap-3 rounded-full bg-primary hover:bg-primary/90 dark:bg-primary dark:hover:bg-primary/80 px-6 py-3 text-primary-foreground font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300 border border-primary/20 overflow-hidden"
