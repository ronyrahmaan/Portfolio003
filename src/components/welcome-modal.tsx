/**
 * A modal that welcomes visitors to Md A Rahman's portfolio. This component
 * showcases Rahman's unique journey across three countries and his diverse
 * expertise in AI/ML, from infrastructure safety to medical diagnostics.
 * It presents a friendly greeting and highlights the portfolio's interactive
 * nature powered by AI.
 */
  ...
  return (
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="bg-background z-52 max-h-[80vh] overflow-auto rounded-xl border-none p-3 py-4 shadow-xl sm:max-w-[80vw] md:max-w-[75vw] lg:max-w-[900px]">
          <motion.div
          ...
          >
            ...
            <DialogHeader className="relative flex flex-row items-start justify-between px-6 pt-6 pb-4">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="sticky top-0 right-0 cursor-pointer rounded-full bg-black p-1.5 text-white hover:bg-black/90 hover:text-white"
            ...
            {/* Content area */}
            <div className="space-y-4 overflow-y-auto px-2 py-3 md:px-6">
